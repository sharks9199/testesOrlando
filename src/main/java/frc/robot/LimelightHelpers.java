...
public class LimelightHelpers {
    ...
    public static double getTZ(String limelightName) {
        return getTargetPose_RobotSpace(limelightName)[2];
    }

    public static double getRY(String limelightName) {
        return getTargetPose_RobotSpace(limelightName)[4];
    }
